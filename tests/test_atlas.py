...
class TestIsolation:
    def test_previous_module_path_is_not_available(self):
        previous_module_name = ".".join(("titan", "li", "ght"))
        with pytest.raises(ModuleNotFoundError):
            importlib.import_module(previous_module_name)

    def test_atlas_not_exported_from_root(self):
        import titan
    ...
    def test_no_external_dependencies(self):
        import titan.atlas._core as core_module
