...
**Adapt:** يجب أن يضمن مسار الـ fallback في `_handle_error` وصول السياق التشخيصي الكامل للمطور — أي أن الـ log المُنتج يحتوي على ما يكفي لتحديد مصدر الخطأ في الكود دون الحاجة لإضافة error handler مسجَّل.
